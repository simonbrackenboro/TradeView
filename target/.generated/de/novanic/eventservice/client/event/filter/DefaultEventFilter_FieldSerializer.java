...
public class DefaultEventFilter_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  private static de.novanic.eventservice.client.event.filter.EventFilter getMyNextEventFilter(de.novanic.eventservice.client.event.filter.DefaultEventFilter instance) {
    return (de.novanic.eventservice.client.event.filter.EventFilter) ReflectionHelper.getField(de.novanic.eventservice.client.event.filter.DefaultEventFilter.class, instance, "myNextEventFilter");
  }
  
  private static void setMyNextEventFilter(de.novanic.eventservice.client.event.filter.DefaultEventFilter instance, de.novanic.eventservice.client.event.filter.EventFilter value) 
  {
    ReflectionHelper.setField(de.novanic.eventservice.client.event.filter.DefaultEventFilter.class, instance, "myNextEventFilter", value);
  }
