...
public class DefaultCompositeEventFilter_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  private static java.util.List getMyEventFilters(de.novanic.eventservice.client.event.filter.DefaultCompositeEventFilter instance) {
    return (java.util.List) ReflectionHelper.getField(de.novanic.eventservice.client.event.filter.DefaultCompositeEventFilter.class, instance, "myEventFilters");
  }
  
  private static void setMyEventFilters(de.novanic.eventservice.client.event.filter.DefaultCompositeEventFilter instance, java.util.List value) 
  {
    ReflectionHelper.setField(de.novanic.eventservice.client.event.filter.DefaultCompositeEventFilter.class, instance, "myEventFilters", value);
  }
