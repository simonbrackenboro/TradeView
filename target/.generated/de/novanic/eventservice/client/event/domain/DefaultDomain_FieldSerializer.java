...
public class DefaultDomain_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  private static java.lang.String getMyName(de.novanic.eventservice.client.event.domain.DefaultDomain instance) {
    return (java.lang.String) ReflectionHelper.getField(de.novanic.eventservice.client.event.domain.DefaultDomain.class, instance, "myName");
  }
  
  private static void setMyName(de.novanic.eventservice.client.event.domain.DefaultDomain instance, java.lang.String value) 
  {
    ReflectionHelper.setField(de.novanic.eventservice.client.event.domain.DefaultDomain.class, instance, "myName", value);
  }
